...
export default function FactsBatchProcessingPanel(): JSX.Element {
  ...
  return (
    <SectionCard
      ...
      title="Batch Generate Facts"
      description="Process multiple source content pieces sequentially to generate facts. Each source is processed one-by-one with a 2-second cooldown between requests."
      collapsible={true}
    >
