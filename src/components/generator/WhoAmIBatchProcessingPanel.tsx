...
import {
  batchGenerateWhoAmIAction,
  getUnprocessedSourcesCountForWhoAmI,
  type BatchProcessResult,
  type UnprocessedSourcesCount,
} from '@/app/main-generator/actions';

export default function WhoAmIBatchProcessingPanel(): JSX.Element {
  ...
  useEffect(() => {
    const fetchCount = async (): Promise<void> => {
      ...
      try {
        const countData = await getUnprocessedSourcesCountForWhoAmI();
  ...
  const handleStartProcessing = (): void => {
    ...
    startTransition(() => {
      batchGenerateWhoAmIAction(count).then((batchResult) => {
  ...
  return (
    <SectionCard
      ...
      title="Batch Generate Who Am I Trivia"
      description="Process multiple source content pieces sequentially to generate Who Am I trivia questions. Each source is processed one-by-one with a 2-second cooldown between requests."
      collapsible={true}
    >
        ...
        <div className="space-y-4">
          <div>
            <div className="flex items-center justify-between mb-2">
              <label
                htmlFor="process-count-who-am-i"
