...
export default function MotivationalCard({
  ...
  onStatusChange,
  onDelete,
}: MotivationalCardProps): JSX.Element {
  ...
  const handleStatusChange = async (newStatus: string): Promise<void> => {
    ...
    try {
      const response = await fetch(`/api/motivational/${motivational.id}`, {
        method: 'PATCH',
      ...
      const errorMessage =
        error instanceof Error ? error.message : 'Failed to update motivational status';
      alert(`Failed to update motivational status: ${errorMessage}`);
    }
  };
  ...
  const handleDelete = async (): Promise<void> => {
    ...
    try {
      ...
      alert('Failed to delete motivational');
    }
  };
