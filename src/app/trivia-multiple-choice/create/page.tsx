...
import type { MultipleChoiceTriviaCreateInput } from '@aska/shared';

async function createMultipleChoiceTriviaAction(formData: FormData): Promise<void> {
  'use server';

  const supabase = await createServerClient();

  // Parse wrong answers from form
  const wrongAnswers = [
  ...
  const triviaData: MultipleChoiceTriviaCreateInput = {
  ...
  const { error } = await supabase.from('trivia_multiple_choice').insert(triviaData);
...
const CreateMultipleChoiceTriviaPage: FC = () => {
  return (
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Add a new multiple choice trivia question
          </p>
        </div>

        <form action={createMultipleChoiceTriviaAction} className="space-y-6">
            ...
            <div className="px-4 py-5 sm:p-6 space-y-6">
              ...
              <div className="space-y-3">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                  ...
                  <span className="text-xs text-gray-500 ml-2">(3 required)</span>
                </label>
                <input
                  type="text"
                  name="wrong_answer_1"
              ...
              <div>
                ...
                <input
                  ...
                  id="category"
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm"
                  placeholder="e.g., Players, Records, History"
                />
              </div>
...
export default CreateMultipleChoiceTriviaPage;
