...
// PATCH /api/who-am-i/[id] - Partially update who am i trivia (archive/status changes)
export async function PATCH(
  ...
  try {
    ...
    console.log('Updating who am i trivia:', { id, updateData });
    ...
    if (error) {
      // eslint-disable-next-line no-console
      console.error('Error patching who am i trivia:', error);
      return NextResponse.json(
        {
          success: false,
          error: 'Failed to update who am i trivia status',
...
// DELETE /api/who-am-i/[id] - Delete who am i trivia entry
export async function DELETE(
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json(
        { success: false, error: 'Failed to delete who am i trivia entry' },
        { status: 500 },
      );
    }
