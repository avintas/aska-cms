...
// PATCH /api/stats/[id] - Partially update stat (archive/status changes)
export async function PATCH(
  ...
  try {
    ...
    console.log('Updating stat:', { id, updateData });
...
// DELETE /api/stats/[id] - Delete stat entry
export async function DELETE(
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json(
        { success: false, error: 'Failed to delete stat entry' },
        { status: 500 },
      );
    }
