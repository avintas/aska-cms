...
export default function MotivationalListPage(): JSX.Element {
  ...
  const totalMotivational = stats.unpublished + stats.published + stats.archived;
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 dark:bg-slate-950 sm:p-8">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <section className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              Manage motivational quotes and inspirational content for the community.
            </p>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-4 text-xs text-gray-600 dark:text-gray-400">
              <div className="flex items-center gap-1.5">
                ...
                <span className="font-medium">{totalMotivational} total</span>
              </div>
              <div className="flex items-center gap-1.5">
        ...
        {/* Motivational List - Card Container */}
          ...
          {loading ? (
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-8 text-center dark:border-slate-800 dark:bg-slate-900/70">
              <p className="text-gray-500 dark:text-gray-400">
                No {getStatusLabel(statusFilter).toLowerCase()} motivational quotes found.
              </p>
            </div>
          ) : (
            <>
              {items.map((motivational) => (
                <MotivationalCard
                  key={motivational.id}
