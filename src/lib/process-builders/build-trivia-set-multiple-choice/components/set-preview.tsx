...
import type { MultipleChoiceQuestionData } from '../lib/types';
...
export default function SetPreview({
  ...
  const triviaSet = result.finalResult as
    | { triviaSet: { question_data: MultipleChoiceQuestionData[]; title: string; description: string | null; question_count: number } }
    | undefined;
