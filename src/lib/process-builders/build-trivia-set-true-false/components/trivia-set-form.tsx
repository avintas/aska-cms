...
import { buildTriviaSetTrueFalseAction } from '../lib/actions';
import type { ProcessBuilderResult, ProcessBuilderRules } from '../../core/types';
import ProcessMessagePanel from '../../build-trivia-set-multiple-choice/components/process-message-panel';
...
export default function TriviaSetForm({
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      ...
      const goal = {
        text: theme.trim() || 'True/False Trivia',
      };
      ...
      // Call server action
      const processResult = await buildTriviaSetTrueFalseAction(goal, rules, options);
