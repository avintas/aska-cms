...
import { buildTriviaSetWhoAmIAction } from '../lib/actions';
...
export default function TriviaSetForm({
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      ...
      const goal = {
        text: theme.trim() || 'Who Am I Trivia',
      };
      ...
      // Call server action
      const processResult = await buildTriviaSetWhoAmIAction(goal, rules, options);
