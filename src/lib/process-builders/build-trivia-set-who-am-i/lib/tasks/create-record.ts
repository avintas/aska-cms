 ...
 * Inserts trivia set into sets_trivia_who_am_i table
 */
  ...
  async execute(context: TaskContext): Promise<TaskResult> {
    try {
      ...
      const questionData = (assembleResult.data as {
        questionData: WhoAmIQuestionData[];
      }).questionData;
      ...
      const triviaSet: Omit<WhoAmITriviaSet, 'id' | 'created_at' | 'updated_at'> = {
      ...
      const completeSet: WhoAmITriviaSet = {
        ...triviaSet,
