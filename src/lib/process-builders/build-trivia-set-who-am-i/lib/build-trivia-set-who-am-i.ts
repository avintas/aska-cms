 ...
 * Main function that orchestrates all tasks to create a Who Am I trivia set
 */
...
/**
 * Build a Who Am I trivia set from existing questions
 */
export async function buildTriviaSetWhoAmI(
  ...
  return {
    ...result,
    processId: 'build-trivia-set-who-am-i',
    processName: 'Build Who Am I Trivia Set',
  };
}
